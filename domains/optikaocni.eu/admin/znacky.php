    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          $edit = $database->znacky->where("id", $_GET['id'])->fetch();
          ?>
         ...
         <div class="row" style="margin-top:10px;">
              <div class="col">
                <div class="card card-small mb-4">
                  ...
                  <form method="post" action="update?upravit-znacku">
                  <input type="hidden" name="id" value="<?= $edit['id'] ?>">
            <div class="form-group">
              <strong style="float:left;">Název</strong><br style="clear:both;">
              <input type="text" name="nazev" class="form-control" value="<?= $edit['nazev'] ?>" placeholder="Název značky">
            </div>
...
<hr>                  
         ...
         <div class="row" style="margin-top:10px;">
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-body p-10 pb-3 text-center">
                  <form enctype="multipart/form-data" method="post" action="update?pridej-znacku">
        
            <div class="form-group">
              <strong style="float:left;">Název</strong><br style="clear:both;">
              <input type="text" name="nazev" class="form-control" placeholder="Název značky">
            </div>
            <div class="form-group">
              <strong style="float:left;">Logo značky (nahrávejte ve velikosti 200x200px v poměru stran 1:1)</strong><br style="clear:both;">
              ...
              <div class="col">
                <div class="card card-small mb-4">
                  <div class="card-header border-bottom">
                    <h6 class="m-0" style="float:left;">Značky</h6>
                    <a href="?pridat" class="btn btn-outline-primary btn-sm" style="margin-left:10px;float:right;">Přidat značku</a>
                  </div>
                  <div class="card-body p-10 pb-3 text-center">
                    <table class="table mb-0" id="myTable">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($database->znacky->order("id ASC") as $zaznam) { 
                        ?>
                        <tr>
                          <td><?= $zaznam['id'] ?></td>
                          <td><?= $zaznam['nazev'] ?></td>
                          <td><img src="files/znacky/<?= $zaznam['pic'] ?>" width="40px"></td>
