...
?>
<?php
  $obsah = $database->pages->where("id", 7)->fetch();
?>
<!DOCTYPE html>
<html lang="cs">
...
<section class="animatedParent animateOnce subbanner subbanner-image subbanner-pattern-06 subbanner-type-2 subbanner-type-2-btn">
    	<div class="container">
        	<div class="subbanner-content banner-content">
            	<div class="skew-effect fadeInLeft animated"><?= $obsah['nadpis'] ?> - !! nový !!</div>
...
<section class="hospital bottom-spacing white-bg">
    	<div class="container">
            ...
            <div class="col-md-8" style="text-align:justify;">
              ...
              <a href="slunecni-bryle-novy" class="btn btn-type1 btn-sm" style="width:100%;font-size:12px;">Všechny značky</a>
              </div>          
             ...
             <?php if (isset($_GET['znacka'])) {  ?>
              ...
              <?php foreach ($database->produkty->where("kategorie", 1)->where("znacka", $_GET['znacka']) as $zaznam) { 
              ...
              <?php foreach ($database->produkty->where("kategorie", 1) as $zaznam) { 
              $status = ($zaznam['sklad'] == 1 ? '<div style="font-size:10px;color:white;background:#fb1391;padding:7px;position:absolute;margin-top:10px;margin-left:10px;">SKLADEM</div>' : '');              
              ?>
