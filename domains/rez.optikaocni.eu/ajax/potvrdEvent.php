...
$datum = $myPost['startDate'];
$cas = $myPost['startTime'];
$email = "info@optikaocni.eu";
$message = "
Dobrý den pane/paní $jmeno,

potvrzujeme vám termín vyšetření $datum v $cas v naší optice ve Frýdlantu nad Ostravicí. V případě potřeby nás prosím kontaktujte na telefonním čísle 730 164 014 nebo e-mailové adrese info@optikaocni.eu.  
