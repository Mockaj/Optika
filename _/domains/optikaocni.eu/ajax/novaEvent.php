...
$email = "durrerova@optikaocni.eu";
$message = "
Dobrý den,

děkujeme za vytvoření rezervace do naší Optiky. Vyčkejte prosím na potvrzení vámi vybraného termínu.   
...
Mail("info@optikaocni.eu,davidkulhavy.dk@gmail.com", "Nová rezervace termínu", $messageInfo, "From: " . $myPost['zemail']);
