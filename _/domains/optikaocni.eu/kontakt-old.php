    	...
    	<div class="container">
        	<div class="row">
                ...
                <div class="col-md-12 marbot10">
                    ...
                    <div class="col-md-3">
                     <h4><span>OČNÍ EU Optika s.r.o.</span></h4>
                <p>Školní 117<br />Frýdlant nad Ostravicí, 739 11</p>
                <p><strong>IČO:</strong> 06848826</br>
                <strong>DIČ:</strong> CZ06848826<br>
                <strong>Č. účtu:</strong>  282734319 / 0300, ČSOB<br>
                <strong>ID datové schránky:</strong> jtf22zz</p>
                <p>
                <strong><i class="fas fa-phone" style="margin-right:8px;"></i>Mobil:</strong>&nbsp;<a href="">+420 730 164 014</a>
                <br />
                <strong><i class="fas fa-at" style="margin-right:8px;"></i>E-mail:</strong> <a href="mailto:frydlant@ocni.eu">info@optikaocni.eu</a> 
                <!--<br />
                <strong><i class="fab fa-facebook" style="margin-right:8px;"></i>Facebook:</strong> <a href="mailto:">odkaz_na_facebook</a>
                --></p>
                <a href="https://www.google.com/maps?ll=49.591509,18.35983&z=17&t=m&hl=cs-CZ&gl=CZ&mapclient=embed&cid=4138169133389934295" target="_blank" class="btn btn-type1 btn-sm">ZOBRAZIT NA MAPĚ</a>
                    </div>
